...
- Agent Workflow 展示页：把分析结果翻译成可落到消息、表格、文档、待办系统的工作流方案。
...
根据当前分析结果生成一套面向协作平台执行的 Agent Workflow 方案。
...
- 展示从数据接入到 AI 推理再到协作平台执行的闭环
- 输出 IM、多维表格、Docs、待办等接入建议
- 自带 Demo Script，便于做产品讲解与流程演示
...
3. 最后把结果翻译成协作平台里的执行动作，体现真实业务落地能力。
